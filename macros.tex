...
\newcommand{\letjtt}{\def\entails{\vdash_{\!J}}\def\isctx{\jttisctx}}
\newcommand{\letatt}{
...
\newcommand{\atteqtype}[6]{#1 \entails^{\!#2} (#3,#4) \equiv (#5,#6)}
...
\newcommand{\asetle}[2]{#1 ≼ #2}
\newcommand{\asetcst}[2]{\asetle {\{#1\}} #2}
